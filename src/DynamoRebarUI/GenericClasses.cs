...
namespace DynamoRebarUI
{
    ...
    public abstract class CustomRevitElementDropDown : RevitDropDownBase
    {
        ...
        [JsonConstructor]
        public CustomRevitElementDropDown(string name, Type elementType, IEnumerable<Dynamo.Graph.Nodes.PortModel> inPorts, IEnumerable<Dynamo.Graph.Nodes.PortModel> outPorts)
    ...
    public abstract class CustomGenericEnumerationDropDown : RevitDropDownBase
    {
        ...
        [JsonConstructor]
        public CustomGenericEnumerationDropDown(string name, Type enumerationType, IEnumerable<Dynamo.Graph.Nodes.PortModel> inPorts, IEnumerable<Dynamo.Graph.Nodes.PortModel> outPorts)
            : base(name, inPorts, outPorts)
        {
            this.EnumerationType = enumerationType;
            PopulateItems();
