...
public abstract class RevitElementDropDown : RevitDropDownBase
{
    /// <summary>
    ...
    public RevitElementDropDown(string name, Type elementType) : base(name) { this.ElementType = elementType; }
...
public abstract class GenericEnumerationDropDown : RevitDropDownBase
{
    ...
    public GenericEnumerationDropDown(string name, Type enumerationType) : base(name) { this.EnumerationType = enumerationType; }
