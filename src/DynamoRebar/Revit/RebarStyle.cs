...
namespace Revit.Elements
{
    public class RebarStyle
    {
        ...
        private RebarStyle(Autodesk.Revit.DB.Structure.RebarStyle rebarStyle)
        {
        ...
        private readonly Autodesk.Revit.DB.Structure.RebarStyle internalElement;
        ...
        internal Autodesk.Revit.DB.Structure.RebarStyle InternalElement
        {
        ...
        /// <returns></returns>
        public static RebarStyle ByName(string name)
        {
            if (name == null)
            {
